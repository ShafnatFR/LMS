...
const Navbar: React.FC<NavbarProps> = ({ currentPage, onNavigate }) => {
  ...
  const NavLink = ({ page, label }: { page: Page, label: string }) => (
    <button 
      ...
      className={`font-medium transition-colors relative py-2 text-sm lg:text-base ${
            ...
            <div className="px-4 pt-4 pb-6 space-y-2">
              ...
              {[
                ...
                <button 
                  ...
                  className={`block w-full text-left px-4 py-3 rounded-lg text-base font-bold transition ${
                    currentPage === item.p 
