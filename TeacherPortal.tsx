                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                           {grades.map((student, idx) => (
                              <tr key={student.id} className="hover:bg-gray-50">
                                 ...
                                 <td className="px-6 py-4 whitespace-nowrap text-center">
                                    <span className={`font-bold ${(student.finalScore || 0) >= 75 ? 'text-green-600' : 'text-red-600'
                                       }`}>
                                       {student.finalScore}
                                    </span>
                                 </td>
                     ...
                     <div className="flex gap-1">
                        {(['H', 'S', 'I', 'A'] as const).map((status) => (
                           <button
                              ...
                              className={`w-8 h-8 rounded-full font-bold text-xs flex items-center justify-center transition-all ${student.attendanceStatus === status
